...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "REST API for ClientFlow CRM, projects, billing, automation, analytics, and AI insights.",
    "VERSION": "1.0.0",
...
GRAPHENE = {
    "SCHEMA": "clientflow.graphql.schema.schema",
    "MIDDLEWARE": ["clientflow.graphql.middleware.JWTAuthenticationMiddleware"],
}
...
LOGGING = {
    ...
    "formatters": {
        ...
        "json": {
            "()": "clientflow.utils.logging.JsonFormatter",
        },
    },
    "handlers": {
        "console": {
            "class": "logging.StreamHandler",
            "formatter": os.getenv("LOG_FORMAT", "verbose"),
        },
    },
    "root": {
        "handlers": ["console"],
